...
// KothaTheme implements the Theme interface with Kotha brand colors.
// It provides both dark and light variants.
type KothaTheme struct {
	BaseTheme
}

// NewKothaTheme creates a new instance of the Kotha theme.
func NewKothaTheme() *KothaTheme {
	// Kotha color palette
	// Dark mode colors
