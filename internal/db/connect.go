...
func Connect() (*sql.DB, error) {
	...
	dbPath := filepath.Join(dataDir, "kotha.db")
	...
	// Prepared statements are available via db.Prepare() but intentionally not used;
	// the application relies on the driver's built-in statement caching.
	return db, nil
}
