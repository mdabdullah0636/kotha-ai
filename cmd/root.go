...
to assist developers in writing, debugging, and understanding code directly from the terminal.`,
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		configProvider := config.NewDefaultProvider(cfg)
		...
		app, err := app.New(ctx, conn, configProvider)
		if err != nil {
...
func initMCPTools(ctx context.Context, app *app.App) {
	go func() {
		...
		agent.GetMcpTools(ctxWithTimeout, app.Permissions, app.ConfigProvider(), logging.GetDefaultLogger())
