...
func NewMcpTool(name string, tool mcp.Tool, permissions permission.Service, mcpConfig config.MCPServer, configProvider config.ConfigProvider, logger logging.Logger) tools.BaseTool {
	return &mcpTool{
		mcpName:        name,
		tool:           tool,
		mcpConfig:      mcpConfig,
...
func getTools(ctx context.Context, name string, m config.MCPServer, permissions permission.Service, c MCPClient, configProvider config.ConfigProvider, logger logging.Logger) []tools.BaseTool {
