...
Kotha supports most common terminal themes and you can create your own custom theme.
...
Where `kotha` is the default theme and `custom` let's you define your own theme.

## Setting a theme

You can set your theme in your Kotha config.
...
You don't need to define all the color keys. Any undefined colors will fall back to the default `kotha` theme colors.
