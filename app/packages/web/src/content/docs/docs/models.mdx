...
Kotha uses the [AI SDK](https://ai-sdk.dev/) to have the support for **all the AI models**.

Start by setting the [keys for the providers](/docs/config) you want to use in your Kotha config.
